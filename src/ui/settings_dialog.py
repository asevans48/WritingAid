...
# Catalog + downloader are owned by the reusable picker module so the
# CreativeOS settings dialog can use the same code. Re-exported below
# for backwards compat with the rest of this file.
from src.ui.model_picker_widget import (
    LocalModelInfo,  # noqa: F401 (re-exported)
    MLX_MODELS,      # noqa: F401
    PYTORCH_MODELS,  # noqa: F401
    get_available_models,
    ModelDownloadWorker,  # noqa: F401
)
