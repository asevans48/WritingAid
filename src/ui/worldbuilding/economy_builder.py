...
class EconomyEditorDialog(QDialog):
    ...
    def _init_ui(self):
        ...
        add_partner_btn.setToolTip("Add a trade partner")
        ...
        remove_partner_btn.setToolTip("Remove the selected partner")
